...
export interface SmallTableRef<T> {
...
export default forwardRef(SmallTableInner) as <T>(
  props: TableProps<T> & React.RefAttributes<SmallTableRef<T>>
